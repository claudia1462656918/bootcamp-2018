...
y<-gapminder$lifeExp
fit <- lm(y ~ x)
plot(y ~ x,xlab="gdpPercap",ylab="lifeExp")
...
for (i in cont){
  fit <- lm(gapminder$lifeExp[gapminder$continent==i]~gapminder$gdpPercap[gapminder$continent==i])
  plot(gapminder$lifeExp[gapminder$continent==i]~gapminder$gdpPercap[gapminder$continent==i],xlab="gdpPercap",ylab="lifeExp",main=i)
  lines(gapminder$gdpPercap[gapminder$continent==i], predict(fit), col = 'blue')
}
